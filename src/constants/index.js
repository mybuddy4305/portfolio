...
const social = [
  {
    id: 1,
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/antonio-fernandez-364928372',
    icon: linkedin,
    icon1: linkedin1,
  },
  {
    id: 2,
    name: 'Instagram',
    url: 'https://www.instagram.com/Antonio-Fernandez',
    icon: instagram,
    icon1: instagram1,
  },
  {
    id: 3,
    name: 'Twitter',
    url: 'https://twitter.com/Antonio-Fernandez',
    icon: twitter,
    icon1: twitter1,
  },
  {
    id: 4,
    name: 'Github',
    url: 'https://github.com/mybuddy4305',
    icon: github,
    icon1: github1,
  },
];
...
const projects = [
  ...
  },
  {
    ...
    tech: ['Next', 'GraphQL', 'Apollo', 'Ruby on Rails', 'PostgreSQL'],
    img: recipeapp,
  ...
  },
  {
    ...
    tech: ['Next', 'Redux', 'Prisma', 'Express', 'Openweather API'],
    img: metricwebapp,
...
const testimonials = [
  {
    ...
    text: 'I really am comfortable with collaborating and coding with Antonio-Fernandez. His ingenious ideas give me a lot of ideas solving a problem multiple ways.',
    country: 'Netherland',
    linkedIn: 'https://www.linkedin.com/in/hozyfa-b-nasir-7bOb2bb8/',
  },
  {
    id: 2,
    name: 'Ryker Nguyen',
    ...
    country: 'Canada',
    linkedIn: 'https://www.linkedin.com/ryker-nguyen7111142368/',
  },
  {
    id: 3,
...
const services = [
  {
    ...
    text: 'WordPress development empowers businesses with scalable, user-friendly websites tailored for performance, SEO, and seamless content management.',
  },
  {
    id: 2,
    icon: react,
  ...
  },
  {
    ...
    text: 'Software development drives innovation by delivering custom, efficient, and reliable digital solutions that solve real-world problems and accelerate growth.',
  },
];
